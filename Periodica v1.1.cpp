...
char b;
start:
cout<<"Press :- 1, to know the Enter the ATOMIC NUMBER of the ELEMENT."<<endl;
...
if(c==4)
cout<<"Periodica v1.0"<<endl;
if(c==4)
cout<<"Copyright. Arnab Mukherjee, 2014"<<endl;
if(c==4)
cout<<"To get Periodica, e-mail 'GET P' to periodica@mgail.com"<<endl;
if(c==4)
cout<<"To send any suggestion, e-mail your suggestion to periodica@gmail.com"<<endl;
else
if(c==1)
...
break;
case 48:
cout<<"The element is= CADIUM"<<endl;
cout<<"Symbol= Cd"<<endl;
...
cout<<"Placed in Block S/D/F/P"<<endl;
cout<<"It is in Lanthanide series"<<endl;
break;
case 61:
...
cout<<"Try again?? Yes(Y/y) or No(N/n)??"<<endl;
cin>>b;
if(b=='y'||b=='Y')
goto start;
else
cout<<"Thank you! Periodica terminating..."<<endl;
}
getch();
}